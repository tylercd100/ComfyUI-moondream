...
class PhiConfig(PretrainedConfig):
    ...
    def _rope_scaling_validation(self):
        ...
        if rope_scaling_type is not None and rope_scaling_type not in ["linear", "dynamic"]:
            # Unknown scaling type — _init_rope will fall back to no scaling.
            return
        rope_scaling_factor = self.rope_scaling.get("factor", None)
        if rope_scaling_type in ("linear", "dynamic") and (
